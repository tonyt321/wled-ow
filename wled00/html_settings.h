...
WiFi Setup</button></form><form action="/settings/leds"><button 
style="display:none" type="submit">LED Preferences</button></form><form 
action="/settings/ui"><button style="display:none" type="submit">User Interface
</button></form><form action="/settings/sync"><button style="display:none" 
type="submit">Sync Interfaces</button></form><form action="/settings/time">
<button style="display:none" type="submit">Time & Macros</button></form><form 
action="/settings/um"><button type="submit">Config</button></form><form 
action="/settings/sec"><button type="submit">Updates</button></form></body>
</html>)=====";
...
function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#security-settings")}function B(){window.open("/","_self")}function U(){window.open("/update","_self")}function GetV() {var d=document;
%CSS%%SCSS%</head><body onload="GetV()">
<form id="form_s" name="Sf" method="post"><div class="helpB"><button 
style="display:none" type="button" onclick="H()">?</button></div><button 
type="button" onclick="B()">Back</button><button type="submit">Save & Reboot
</button><hr><h2>OTA Update</h2><button type="button" onclick="U()">
Manual OTA Update</button><br>Enable ArduinoOTA: <input type="checkbox" 
name="AO"><br><h3>About</h3><a 
href="https://github.com/tonyt321/wled-ow/releases" target="_blank">RGB Thing
</a> version 0.13.0-b0<br><br><a href="https://kno.wled.ge/about/contributors/" 
...
<div style="display:none" class="helpB"><button type="button" onclick="H()">?
...
</span><hr></div><h2>Usermod Setup</h2><div id="um">Loading settings...</div>
<hr><button type="button" onclick="B()">Back</button><button type="submit">Save
</button></form></body></html>)=====";
